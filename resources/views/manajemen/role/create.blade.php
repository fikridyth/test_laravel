                ...
                <div class="col">
                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                        ...
                        <div class="card-body pt-5">
                            <form action="{{ route('manajemen-role.store') }}" class="form" method="POST">
                                @csrf
                                                ...
                                                <li style="list-style: none">
                                                    <label class="form-check form-check-custom form-check-solid mb-3">
                                                        <input class="form-check-input" type="checkbox" name="id_menu[]"
                                                            value="{{ $menu->id }}"
                                                            {{ is_array(old('id_menu')) && in_array($menu->id, old('id_menu')) ? ' checked' : '' }} />
                                                            ...
                                                            <li style="list-style: none">
                                                                <label
                                                                    ...
                                                                    <input class="form-check-input" type="checkbox"
                                                                        ...
                                                                        {{ is_array(old('id_submenu')) && in_array($submenu->id, old('id_submenu')) ? ' checked' : '' }} />
                                                                    <span class="form-check-label">
                                                                        {{ $submenu->nama }}
                                                                    </span>
                                                                </label>
