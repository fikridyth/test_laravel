                    ...
                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                        <div class="card-header pt-7" id="kt_chat_contacts_header">
                            <div class="card-title">
                                ...
                                <h2>{{ $title }} {{ $stmtMenu->nama }}</h2>
                            </div>
                        </div>
                        <div class="card-body pt-5">
                            <form action="{{ route('manajemen-menu.update', $stmtMenu->id) }}" class="form"
                                method="POST">
                                @method('put')
                                @csrf
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text"
                                        ...
                                        name="nama" value="{{ old('nama', $stmtMenu->nama) }}" id="nama" />
                                    @error('nama')
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text"
                                        ...
                                        id="link" name="link" value="{{ old('link', $stmtMenu->link) }}" />
                                    @error('link')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="number" min="1"
                                        ...
                                        id="urutan" name="urutan" value="{{ old('urutan', $stmtMenu->urutan) }}" />
                                    @error('urutan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
